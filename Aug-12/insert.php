...
$sql= "INSERT INTO student1(Name,FatherName,PersonalAddress,Sex,City,Course,District,State,PinCode,EmailId,Dob,MobileNo) values ('$name','$fname','$address','$sex','$city','$course','$district','$state','$pin','$email','$dob','$mobile')";
